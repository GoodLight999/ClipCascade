...
const currentCode = '        versionCode 320121';
const previousName = '        versionName "3.2.1-extended.4"';
const currentName = '        versionName "3.2.1-extended.17"';
...
console.log('Prepared Android Extended Gmail notification reliability build.');
