...
const currentCode = '        versionCode 320111';
const previousName = '        versionName "3.2.1-extended.4"';
const currentName = '        versionName "3.2.1-extended.7"';
...
console.log('Prepared Android runtime-control repair build 3.2.1-extended.7 / 320111.');
