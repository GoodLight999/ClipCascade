...
const currentCode = '        versionCode 320119';
const previousName = '        versionName "3.2.1-extended.4"';
const currentName = '        versionName "3.2.1-extended.15"';
...
console.log('Prepared Android Extended ACK-safe durable clipboard queue build.');
