...
const currentCode = `        versionCode ${320115 + 1}`;
const previousName = '        versionName "3.2.1-extended.4"';
const currentName = '        versionName "3.2.1-extended.12"';
...
console.log('Prepared Android Extended background clipboard recovery build.');
