...
const currentCode = `        versionCode ${320114 + 1}`;
const previousName = '        versionName "3.2.1-extended.4"';
const currentName = '        versionName "3.2.1-extended.11"';
...
console.log('Prepared Android Extended OTP self-test dispatch build.');
