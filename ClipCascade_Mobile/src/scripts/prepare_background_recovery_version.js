...
const currentCode = `        versionCode ${320116 + 1}`;
const previousName = '        versionName "3.2.1-extended.4"';
const currentName = '        versionName "3.2.1-extended.13"';
...
console.log('Prepared Android Extended selection-only copy fix build.');
