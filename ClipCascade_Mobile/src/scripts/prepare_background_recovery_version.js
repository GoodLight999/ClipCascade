...
const currentCode = '        versionCode 320126';
const previousName = '        versionName "3.2.1-extended.4"';
const currentName = '        versionName "3.2.1-extended.21-alpha.1"';
...
console.log('Prepared Android Extended Go-overlay clipboard recovery alpha build.');
