...
const currentCode = '        versionCode 320110';
const previousName = '        versionName "3.2.1-extended.4"';
const currentName = '        versionName "3.2.1-extended.6"';
...
console.log('Prepared Android storage/duplicate repair build 3.2.1-extended.6 / 320110.');
