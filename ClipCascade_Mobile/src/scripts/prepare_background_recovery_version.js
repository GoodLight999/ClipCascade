...
const currentCode = '        versionCode 320109';
const previousName = '        versionName "3.2.1-extended.4"';
const currentName = '        versionName "3.2.1-extended.5"';
...
console.log('Prepared Android background-recovery build 3.2.1-extended.5 / 320109.');
