...
Highest priority: reliable Android background clipboard delivery through the existing ClipCascade foreground-service/STOMP transport.
...
- Commit `24f116b0895417b434692ca26db853b0e8bc5c51` temporarily replaced this Handoff with `# invalid`. Product code/artifacts were unaffected and the document was restored.
- Commit `68d37b0d7030ddc82026f171439df31ab5617324` mistakenly shortened the restored Handoff. It was restored again.
- Commit `47364e00c785be932fba61b52062aeddeecb8a8b` repeated an unintended shortening during documentation-only work. This commit restores the complete canonical document. Do not use those temporary commits as continuation sources.
